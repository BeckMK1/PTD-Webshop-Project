    ...
    <div class="sale">
      <div class="cTitle">
        ...
        <article  v-for="clothing in clothings" :key="clothing.id">
            <div class="cEach" v-if="clothing.onsale" @click="goTodetail(clothing.id)">
          <div class="image">
        ...
        <div>
         <p>on sale: {{clothing.off}}</p>
        </div>
        <div class="price-buy">
          <p class="price">$ {{clothing.price*clothing.offcal}}</p>
          <p class="onsale">${{clothing.price}}</p>
          <div class="buy-btn">
          <button>buy</button>
          </div>
          </div>
